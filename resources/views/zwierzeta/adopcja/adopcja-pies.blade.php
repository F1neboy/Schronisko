                ...
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-9" id="main-image">
                            <img src="../{{ $pies[0]->zdjecie }}" alt="zdjecie_psa" id="0">
                        </div>
                        ...
                        <div class="col-md-12 gallery scroll-menu" id="scroll-t1">
                            <img src="../{{ $pies[0]->zdjecie }}" class="gallery-item" alt="zdjecie_psa">
                    ...
                    <table class="table table-striped">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ \Carbon\Carbon::parse($pies[0]->data_dodania)->format('d.m.Y') }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
